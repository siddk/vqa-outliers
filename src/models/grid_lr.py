...
Implementation of Grid (Pooled ResNet-101) Feature-Based Logistic Regression for VQA.
"""
...
class GridLogisticRegression(pl.LightningModule):
    ...
    def build_model(self):
        ...
        self.linear = nn.Linear(self.train_dataset.dim + self.hparams.emb_dim, len(self.ans2label))
    ...
    def forward(self, image_features, question_features):
        ...
        # Joint Features
        joint = torch.cat([embs, image_features], dim=1)
